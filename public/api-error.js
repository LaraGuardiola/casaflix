export const API_ERROR = {
    filesNotFound: 'No se encuentran archivos en la ruta especificada.',
    fileNotFound: 'No se encuentra el archivo en el sistema.',
    ...
    noFileSelectedError: 'No has seleccionado video.'
}